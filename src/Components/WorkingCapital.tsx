...
const WorkingCapital: React.FC<PersonalLoanProps> = ({rightImg}) => {
  return (
    <>
      <SubNav
        main="Home"
  ...
  {/*7. Working Capital loan ends*/}
        ...
        <div className="lg:w-2/3 ">
          ...
          <div className="business-heading p-10">
            ...
            Working Capitals from PR GROW are an unsecured form of credit, making them an ideal solution to meet immediate financial needs. These loans are versatile and can be used for a variety of purposes, such as weddings, home renovations, travel expenses, and more. With PR GROW Working Capitals, there are no restrictions on how the borrowed amount is used, providing you with the freedom to allocate funds as you see fit.

One significant advantage of a PR GROW Working Capital is the potential to build your credit more quickly compared to other forms of credit. This is due to the higher risk associated with unsecured loans, which, when managed well, can positively impact your credit score. PR GROW Working Capitals are designed to be accessible, with minimal documentation required, fast processing times, and immediate disbursal to your bank account. 

Whether you need funds urgently for an unexpected expense or to achieve a personal goal, PR GROW Working Capitals offer a straightforward and efficient way to access the money you need quickly. Choose PR GROW for a reliable and flexible financial solution to meet your immediate requirements.
            </p>
          </div>
