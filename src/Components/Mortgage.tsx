...
import personal from "../assets/mortgage/mort.avif";
...
const Mortgage: React.FC<PersonalLoanProps> = ({rightImg}) => {
  return (
    <>
      <SubNav
        main="Home"
        submain="Service Details"
        heading="Mortgage Loan Details"
        bgimg={personal}
      />
  ...
  {/*7. Working Capital loan ends*/}
        ...
        <div className="lg:w-2/3 ">
          ...
          <div className="business-heading p-10">
            <h1 className="text-4xl font-bold ">Mortgage Loan</h1>
            <p className="lg:p-10 p-2 py-10">
            Mortgage Loans from PR GROW are an unsecured form of credit, making them an ideal solution to meet immediate financial needs. These loans are versatile and can be used for a variety of purposes, such as weddings, home renovations, travel expenses, and more. With PR GROW Mortgage Loans, there are no restrictions on how the borrowed amount is used, providing you with the freedom to allocate funds as you see fit.

One significant advantage of a PR GROW Mortgage Loan is the potential to build your credit more quickly compared to other forms of credit. This is due to the higher risk associated with unsecured loans, which, when managed well, can positively impact your credit score. PR GROW Mortgage Loans are designed to be accessible, with minimal documentation required, fast processing times, and immediate disbursal to your bank account. 

Whether you need funds urgently for an unexpected expense or to achieve a personal goal, PR GROW Mortgage Loans offer a straightforward and efficient way to access the money you need quickly. Choose PR GROW for a reliable and flexible financial solution to meet your immediate requirements.
            </p>
          </div>

          {/* right side  */}
          <div className="business-heading p-10">
            <h1 className="text-4xl font-bold ">Types of Mortgage Loan</h1>
            <ul className="p-10">
