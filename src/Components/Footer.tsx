      ...
      <div className="flex flex-col lg:flex-row bg-slate-600 text-white">
        <div className="w-full lg:w-1/2 lg:flex">
          <div className="w-full lg:w-1/2 p-8">
            <div>
                <img src="https://upgroww.com/assets/images/logo.png" alt="" />
            </div>
            <p>
...
{/* contact section below */}
        <div className="w-full lg:w-1/2 lg:flex">
          <div className="w-full lg:w-1/2 p-8">
            <div>
              ...
              <div className="flex items-center">
                ...
                <span>Upgroww excellence in providing the best loan</span>
              </div>
            </div>
          </div>
          <div className="w-full lg:w-1/2 p-8 bg-blue-950 lg:m-10">
            ...
            <div className="mb-4 flex border-b border-gray-400 py-2">
                ...
                <div className="m-1"> info@upgroww.in
                    <br/>
                        support@upgroww.in
                </div>
            </div>
            ...
            <div className="mb-4 flex py-2">
                ...
                <div className="m-1"> Office Address - 5th Floor, Ravi Complex Above Bata ,Kurji More, Patliputra Industrial estate, Patna - 800010
                </div>
            </div>
          </div>
        </div>
      ...
      <div className="Copyright lg:flex w-full justify-around bg-blue-950">
        <div className="lg:w-1/3 flex justify-center align-middle "><span className="text-white mx-1">© Copyright 2022 by</span> <span className="text-blue-500 ">Upgroww Solutions Pvt. Ltd.</span></div>
